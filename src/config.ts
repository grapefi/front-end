...
const configurations: {[env: string]: Configuration} = {
  development: {
    ...
    externalTokens: {
      ...
      GRAPE: ['0x36a573f26f835702bdf1dd06a601f3fe16dbb197', 18],
      XGRAPE: ['0x95CED7c63eA990588F3fd01cdDe25247D04b8D98', 18],
      ...
      'GRAPE-XGRAPE-LP': ['0x3ebc3b45d5Fc60e01159984d93F7f2ba5774315b', 18],
...
export const bankDefinitions: {[contractName: string]: BankInfo} = {
  ...
  */
  ...
  Sodapress: {
    ...
    sectionInUI: 8,
    contract: 'Sodapress',
    depositTokenName: 'GRAPE-XGRAPE-LP',
    earnTokenName: 'GRAPE-XGRAPE-LP',
    finished: false,
    sort: 2,
    closedForStaking: false,
    multi: '0',
  ...
  Solerapress: {
    ...
    poolId: 0,
    sectionInUI: 8,
    contract: 'Solerapress',
    depositTokenName: 'sVintage',
    earnTokenName: 'sVintage',
    finished: false,
    sort: 2,
    closedForStaking: false,
    multi: '0',
  ...
  GrapeWineLPWineRewardPool: {
    ...
    multi: '3.70',
    buyLink:
      'https://traderjoexyz.com/trade?inputCurrency=0xC55036B5348CfB45a932481744645985010d3A44&outputCurrency=0x5541D83EFaD1f281571B343977648B75d95cdAC2#/',
  },
  ...
  vintageStaking: {
    name: 'Earn WINE with sVintage',
    poolId: 7,
    sectionInUI: 7,
    contract: 'vintageStaking',
    depositTokenName: 'sVintage',
    earnTokenName: 'WINE',
    finished: false,
    sort: 4,
