...
export class GrapeFinance {
  ...
  unlockWallet(provider: any, account: string) {
    const newProvider = new ethers.providers.Web3Provider(provider, 43113);
  ...
  async getSodapressData(): Promise<PressUserInfo> {
    ...
    console.log(' sodapress address = ' + Sodapress.address);
